...
public class ErrorLogger {
    ...
    private static  String errorFileName="ErrorLog";
    ...
    private static void initializeLogging()  {
            ...
            //If we are not given a path for the error file, then ask java for the file
            errorLogger = Logger.getLogger(logFile);
            Debug.println("Using the error logger file " +  errorLogger.getName());
    }
    ...
    public static void initializeLogging(String logDirectoryPath, String errorLogName)  {
        ...
        try {
            ...
            errorLogger.log(Level.SEVERE, "Could not create file handler for error logger "+filePath, ex);
        }
    }
    ...
    public static void main(String [] args){
        //This will not create a log file
